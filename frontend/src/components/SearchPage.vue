            ...
            <md-list-item v-for="recipe in shownRecipes" :to="'/recipe/' + recipe.id">
              ...
              <div class="md-list-item-text">
                ...
                <div>Lisatud: {{ new Date(recipe.added).toLocaleDateString("et-ET", {day: "2-digit", month: "2-digit", year: "numeric"}) }} ({{ recipe.user.username }})
                  <div v-if="recipe.preparedHistory" :id="'recipe' + recipe.id + 'preparedtime'">Viimati valmistasin: {{ new Date(recipe.preparedHistory[0].preparedTime).toLocaleDateString("et-ET")}} </div>
                </div>
